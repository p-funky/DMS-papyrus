            ...
            <form className="col s12" onSubmit={this.onSubmit}>
              <div className="row">
                <div className="input-field col s12">
                  ...
                  <input id="firstName" type="text" className="validate" onChange={this.onChange} />
              ...
              <div className="row">
                <div className="input-field col s12">
                  <i className="material-icons prefix">perm_identity</i>
                  <input id="lastName" type="text" className="validate" onChange={this.onChange} />
              ...
              <div className="row">
                <div className="input-field col s12">
                  ...
                  <input id="userName" type="text" className="validate" onChange={this.onChange} />
              ...
              <div className="row">
                <div className="input-field col s12">
                  <i className="material-icons prefix">lock</i>
                  <input id="password_confirm" type="password" className="validate" onChange={this.onChange} />
